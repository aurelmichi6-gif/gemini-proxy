        ...
        const response = await fetch(
            "https://integrate.api.nvidia.com/v1/chat/completions",
            {
                ...
                body: JSON.stringify({
                    ...
                    messages: [{
                        role: "user",
                        content: " You are playing a game against gemini AI. Answer this situation/question with respect, short, clear, kind, safe, on-topic, logic, non vague, and appropriate (max 50 characters): " + question
                    }],
                    max_tokens: 1000,
                    temperature: 1.00,
                    top_p: 1.00,
