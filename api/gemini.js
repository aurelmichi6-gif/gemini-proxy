        ...
        const response = await fetch(
            "https://integrate.api.nvidia.com/v1/chat/completions",
            {
                ...
                body: JSON.stringify({
                    ...
                    messages: [{
                        role: "user",
                        content: " I will give you a question. You have to answer this situation/question with short, direct, clear, kind, safe, on-topic, logic, creative and non vague (max 50 words): " + question
                    }],
                    max_tokens: 1000,
                    temperature: 1.00,
                    top_p: 1.00,
